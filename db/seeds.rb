...
c4 = Comment.create!(content: "Wow very neat", video_id: v2.id, author_id: u6.id)
...
c15 = Comment.create!(content: "Hey! Demo user here with a nice demo comment. Try signing in and writing one of your own!", video_id: v11.id, author_id: u1.id)
c16 = Comment.create!(content: "Hey! Demo user here with a nice demo comment. Try signing in and writing one of your own!", video_id: v12.id, author_id: u1.id)
c17 = Comment.create!(content: "Hey! Demo user here with a nice demo comment. Try signing in and writing one of your own!", video_id: v13.id, author_id: u1.id)
