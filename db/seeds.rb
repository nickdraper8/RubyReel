...
Subscription.create!(creator_id: u3.id, subscriber_id: u10.id)
Subscription.create!(creator_id: u4.id, subscriber_id: u10.id)
Subscription.create!(creator_id: u5.id, subscriber_id: u10.id)
Subscription.create!(creator_id: u6.id, subscriber_id: u10.id)
Subscription.create!(creator_id: u7.id, subscriber_id: u10.id)
Subscription.create!(creator_id: u8.id, subscriber_id: u10.id)
Subscription.create!(creator_id: u9.id, subscriber_id: u10.id)
