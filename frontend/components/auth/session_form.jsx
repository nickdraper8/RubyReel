    ...
    render() {
        ...
        return (
            <main class="signup-login-form-container">
                <span class="signup-login-logo"><span class="iconify" data-icon="mdi-language-ruby"></span>RubyReel</span>
                <span class="signup-login-title">{formTypeText}</span>
                <span class="signup-login-after-title">to continue to RubyReel</span>
