            ...
            <div>
                <main className="signup-login-form-container signup">
                    <div className="signup-left">
                        <Link to="/" id="signup-logo"><span className="iconify" data-icon="mdi-language-ruby"></span>RubyReel</Link>
                        <span className="signup-login-title signup">{formTypeText}</span>
                        <span className="signup-login-after-title signup">to continue to RubyReel</span>
                        <form>
                    ...
                    <div className="signup-right">
                        ...
                        <span id="signup-blurb">One account to rule them all. The full power of RubyReel awaits you!</span>
                    </div>
                </main>
                <footer id="login-footer" class="signup-footer">
                    ...
                    <ul id="login-page-links">
                        <li>
                            <a href="https://github.com/nickdraper8">GitHub</a>
                        </li>
                        <li>
